...
mc mb $MINIO_ALIAS/${MINIO_BUCKET_MARKET_LISTING_ATTACHMENTS:-market-listing-attachments}
...
# Allow the public to download files certain buckets
mc anonymous set download $MINIO_ALIAS/${MINIO_BUCKET_CHAT_ATTACHMENTS:-chat-attachments}
mc anonymous set download $MINIO_ALIAS/${MINIO_BUCKET_MARKET_LISTING_ATTACHMENTS:-market-listing-attachments}
