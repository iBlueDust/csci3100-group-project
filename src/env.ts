...
const { error, value: env } = schema.validate(
	{
		...process.env,
		CHAT_TEXT_MESSAGE_MAX_SIZE: process.env.CHAT_TEXT_MESSAGE_MAX_SIZE || process.env.NEXT_PUBLIC_CHAT_TEXT_MESSAGE_MAX_SIZE,
		CHAT_ATTACHMENT_MAX_SIZE: process.env.CHAT_ATTACHMENT_MAX_SIZE || process.env.NEXT_PUBLIC_CHAT_ATTACHMENT_MAX_SIZE,
		CHAT_ATTACHMENT_FILENAME_MAX_SIZE: process.env.CHAT_ATTACHMENT_FILENAME_MAX_SIZE || process.env.NEXT_PUBLIC_CHAT_ATTACHMENT_FILENAME_MAX_SIZE,
		MARKET_LISTING_ATTACHMENT_LIMIT: process.env.MARKET_LISTING_ATTACHMENT_LIMIT || process.env.NEXT_PUBLIC_MARKET_LISTING_ATTACHMENT_LIMIT,
		MARKET_LISTING_ATTACHMENT_SIZE_LIMIT: process.env.MARKET_LISTING_ATTACHMENT_SIZE_LIMIT || process.env.NEXT_PUBLIC_MARKET_LISTING_ATTACHMENT_SIZE_LIMIT,
		MARKET_LISTING_TITLE_MAX_LENGTH: process.env.MARKET_LISTING_TITLE_MAX_LENGTH || process.env.NEXT_PUBLIC_MARKET_LISTING_TITLE_MAX_LENGTH,
		MARKET_LISTING_DESCRIPTION_MAX_LENGTH: process.env.MARKET_LISTING_DESCRIPTION_MAX_LENGTH || process.env.NEXT_PUBLIC_MARKET_LISTING_DESCRIPTION_MAX_LENGTH,
	}, {
	allowUnknown: true,
	abortEarly: false,
})
